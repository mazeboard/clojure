...
var G__718 = o;
goog.object.set(G__718,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__722 = o;
goog.object.set(G__722,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__723__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__723 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__724__i = 0, G__724__a = new Array(arguments.length -  0);
while (G__724__i < G__724__a.length) {G__724__a[G__724__i] = arguments[G__724__i + 0]; ++G__724__i;}
  args = new cljs.core.IndexedSeq(G__724__a,0,null);
} 
return G__723__delegate.call(this,args);};
G__723.cljs$lang$maxFixedArity = 0;
G__723.cljs$lang$applyTo = (function (arglist__725){
var args = cljs.core.seq(arglist__725);
return G__723__delegate(args);
});
...
var G__726 = props;
var G__726__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__726,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__726);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__726__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4223__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__727 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__727,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__727;
}
})(),id_class);
...
var G__728 = (cljs.core.count.call(null,argv) - first_child);
switch (G__728) {
case (0):
...
var vec__730 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__730,(0),null);
var id = cljs.core.nth.call(null,vec__730,(1),null);
var className = cljs.core.nth.call(null,vec__730,(2),null);
...
var temp__5757__auto___733 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5757__auto___733 == null)){
} else {
var key_734 = temp__5757__auto___733;
(jsprops.key = key_734);
}
...
var temp__5757__auto___735 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5757__auto___735 == null)){
} else {
var key_736 = temp__5757__auto___735;
(jsprops.key = key_736);
}
...
var temp__5757__auto___737 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5757__auto___737 == null)){
} else {
var key_738 = temp__5757__auto___737;
(jsprops.key = key_738);
}
...
var temp__5757__auto___739 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5757__auto___739 == null)){
} else {
var key_740 = temp__5757__auto___739;
(jsprops.key = key_740);
}
...
var temp__5757__auto___741 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5757__auto___741 == null)){
} else {
var key_742 = temp__5757__auto___741;
(jsprops.key = key_742);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__743_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__743_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__744 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__744,(0),null);
var derefed = cljs.core.nth.call(null,vec__744,(1),null);
...
break;
default:
var G__749 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__750 = compiler;
v = G__749;
compiler = G__750;
continue;
...
var G__751 = tag;
var G__751__$1 = (((G__751 instanceof cljs.core.Keyword))?G__751.fqn:null);
switch (G__751__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template754 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template754 = (function (opts,id,fn_to_element,parse_fn,meta755){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta755 = meta755;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template754.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_756,meta755__$1){
var self__ = this;
var _756__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template754(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta755__$1));
}));

(reagent.impl.template.t_reagent$impl$template754.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_756){
var self__ = this;
var _756__$1 = this;
return self__.meta755;
}));

(reagent.impl.template.t_reagent$impl$template754.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template754.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template754.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template754.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template754.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template754.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta755","meta755",3387266,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template754.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template754.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template754");

(reagent.impl.template.t_reagent$impl$template754.cljs$lang$ctorPrWriter = (function (this__4461__auto__,writer__4462__auto__,opt__4463__auto__){
return cljs.core._write.call(null,writer__4462__auto__,"reagent.impl.template/t_reagent$impl$template754");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template754.
 */
reagent.impl.template.__GT_t_reagent$impl$template754 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template754(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta755){
return (new reagent.impl.template.t_reagent$impl$template754(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta755));
});

}

return (new reagent.impl.template.t_reagent$impl$template754(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});

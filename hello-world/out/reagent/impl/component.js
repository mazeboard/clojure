...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__669 = c;
var G__669__$1 = (((G__669 == null))?null:G__669.prototype);
if((G__669__$1 == null)){
return null;
} else {
return G__669__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__670 = c;
var G__670__$1 = (((G__670 == null))?null:G__670.prototype);
if((G__670__$1 == null)){
return null;
} else {
return G__670__$1.render;
}
})() == null)))));
});
...
var or__4223__auto__ = (function (){var G__678 = c;
var G__678__$1 = (((G__678 == null))?null:G__678.constructor);
if((G__678__$1 == null)){
return null;
} else {
return G__678__$1.displayName;
}
})();
...
var G__679 = c;
var G__679__$1 = (((G__679 == null))?null:G__679.constructor);
if((G__679__$1 == null)){
return null;
} else {
return G__679__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__680 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__681 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__681);

try{return reagent.impl.component.wrap_render.call(null,c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__680);
}});
reagent.impl.component.rat_opts = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"no-cache","no-cache",1588056370),true], null);
reagent.impl.component.custom_wrapper = (function reagent$impl$component$custom_wrapper(key,f){
var G__682 = key;
var G__682__$1 = (((G__682 instanceof cljs.core.Keyword))?G__682.fqn:null);
switch (G__682__$1) {
...
var c = this;
var G__684_686 = goog.object.get(c,"cljsRatom");
if((G__684_686 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__684_686);
}
...
var renders_687 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_688 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_687));
...
if((cljs.core.count.call(null,renders_687) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_687))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_688)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_688)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__689 = o;
goog.object.set(G__689,cljs.core.name.call(null,k),v);
...
return (function() { 
var G__690__delegate = function (args){
return reagent.impl.protocols.as_element.call(null,compiler,cljs.core.apply.call(null,cljs.core.vector,res,args));
};
var G__690 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__691__i = 0, G__691__a = new Array(arguments.length -  0);
while (G__691__i < G__691__a.length) {G__691__a[G__691__i] = arguments[G__691__i + 0]; ++G__691__i;}
  args = new cljs.core.IndexedSeq(G__691__a,0,null);
} 
return G__690__delegate.call(this,args);};
G__690.cljs$lang$maxFixedArity = 0;
G__690.cljs$lang$applyTo = (function (arglist__692){
var args = cljs.core.seq(arglist__692);
return G__690__delegate(args);
});
G__690.cljs$core$IFn$_invoke$arity$variadic = G__690__delegate;
return G__690;
})()
...
var _STAR_current_component_STAR__orig_val__695 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__696 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__696);

try{return reagent.impl.component.functional_wrap_render.call(null,compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__695);
}});
...
var vec__697 = reagent.impl.component.global$module$react.useState((0));
var _ = cljs.core.nth.call(null,vec__697,(0),null);
var update_count = cljs.core.nth.call(null,vec__697,(1),null);
...
var G__700 = goog.object.get(reagent_state,"cljsRatom");
if((G__700 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_.call(null,G__700);
}
});
}),[]);

...
var G__41069 = devtools.prefs.pref(v);
v = G__41069;
continue;
} else {
return v;
...
}catch (e41006){var _e__39406__auto__ = e41006;
return false;
}})();
...
}catch (e41016){var _e__39406__auto__ = e41016;
return false;
}})();
...
}catch (e41018){var _e__39406__auto__ = e41018;
return false;
}}
}
});
...
var vec__41039 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41039,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41039,(1),null);
...
return cljs.core.some((function (p1__41043_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__41043_SHARP_);
}),template);
});

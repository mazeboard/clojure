...
var G__40756 = devtools.prefs.pref(v);
v = G__40756;
continue;
} else {
return v;
...
}catch (e40714){var _e__39615__auto__ = e40714;
return false;
}})();
...
}catch (e40721){var _e__39615__auto__ = e40721;
return false;
}})();
...
}catch (e40724){var _e__39615__auto__ = e40724;
return false;
}}
}
});
...
var vec__40739 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40739,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40739,(1),null);
...
return cljs.core.some((function (p1__40746_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__40746_SHARP_);
}),template);
});

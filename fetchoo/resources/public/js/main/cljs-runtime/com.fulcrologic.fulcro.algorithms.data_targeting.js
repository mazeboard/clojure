...
var len__4730__auto___63787 = arguments.length;
var i__4731__auto___63788 = (0);
while(true){
if((i__4731__auto___63788 < len__4730__auto___63787)){
args__4736__auto__.push((arguments[i__4731__auto___63788]));

var G__63789 = (i__4731__auto___63788 + (1));
i__4731__auto___63788 = G__63789;
continue;
} else {
}
break;
...
/** @this {Function} */
com.fulcrologic.fulcro.algorithms.data_targeting.multiple_targets.cljs$lang$applyTo = (function (seq63721){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq63721));
});
...
var args__4736__auto__ = [];
var len__4730__auto___63793 = arguments.length;
var i__4731__auto___63794 = (0);
while(true){
if((i__4731__auto___63794 < len__4730__auto___63793)){
args__4736__auto__.push((arguments[i__4731__auto___63794]));

var G__63795 = (i__4731__auto___63794 + (1));
i__4731__auto___63794 = G__63795;
continue;
} else {
}
break;
...
return (function (state__$1,p__63754){
var vec__63755 = p__63754;
var command = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63755,(0),null);
var data_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63755,(1),null);
var already_has_ident_at_path_QMARK_ = ((function (vec__63755,command,data_path,actions){
return (function (data_path__$1){
return cljs.core.some(((function (vec__63755,command,data_path,actions){
return (function (p1__63746_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__63746_SHARP_,ident);
});})(vec__63755,command,data_path,actions))
,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(state__$1,data_path__$1));
});})(vec__63755,command,data_path,actions))
;
var G__63762 = command;
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(state__$1,data_path,((function (G__63762,G__63762__$1,already_has_ident_at_path_QMARK_,vec__63755,command,data_path,actions){
return (function (p1__63747_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [ident], null),p1__63747_SHARP_);
});})(G__63762,G__63762__$1,already_has_ident_at_path_QMARK_,vec__63755,command,data_path,actions))
);
}
...
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$10(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"error","error",-978969032),"com.fulcrologic.fulcro.algorithms.data-targeting",null,93,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay(((function (path_to_vector,to_many_QMARK_,index,vector,G__63762,G__63762__$1,already_has_ident_at_path_QMARK_,vec__63755,command,data_path,actions){
return (function (){
...
});})(path_to_vector,to_many_QMARK_,index,vector,G__63762,G__63762__$1,already_has_ident_at_path_QMARK_,vec__63755,command,data_path,actions))
,null)),null,412869394);
}

if(to_many_QMARK_){
if((!(cljs.core.vector_QMARK_(vector)))){
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$10(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"error","error",-978969032),"com.fulcrologic.fulcro.algorithms.data-targeting",null,96,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay(((function (path_to_vector,to_many_QMARK_,index,vector,G__63762,G__63762__$1,already_has_ident_at_path_QMARK_,vec__63755,command,data_path,actions){
return (function (){
...
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$10(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"error","error",-978969032),"com.fulcrologic.fulcro.algorithms.data-targeting",null,97,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay(((function (path_to_vector,to_many_QMARK_,index,vector,G__63762,G__63762__$1,already_has_ident_at_path_QMARK_,vec__63755,command,data_path,actions){
return (function (){
...
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$10(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"error","error",-978969032),"com.fulcrologic.fulcro.algorithms.data-targeting",null,98,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay(((function (path_to_vector,to_many_QMARK_,index,vector,G__63762,G__63762__$1,already_has_ident_at_path_QMARK_,vec__63755,command,data_path,actions){
return (function (){
...
/** @this {Function} */
com.fulcrologic.fulcro.algorithms.data_targeting.integrate_ident_STAR_.cljs$lang$applyTo = (function (seq63750){
var G__63751 = cljs.core.first(seq63750);
var seq63750__$1 = cljs.core.next(seq63750);
var G__63752 = cljs.core.first(seq63750__$1);
var seq63750__$2 = cljs.core.next(seq63750__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__63751,G__63752,seq63750__$2);
});
...
var G__63778 = cljs.core.assoc_in(state_map,target,item_to_place);
if(cljs.core.truth_(remove_source_QMARK_)){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__63778,source_path);
} else {
return G__63778;
}
} else {
if(com.fulcrologic.fulcro.algorithms.data_targeting.multiple_targets_QMARK_(target)){
var G__63779 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (item_to_place,many_idents_QMARK_){
return (function (s,t){
...
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__63779,source_path);
} else {
return G__63779;
}
} else {
...
if(com.fulcrologic.fulcro.algorithms.data_targeting.special_target_QMARK_(target)){
var G__63783 = state_map;
var G__63783__$1 = (cljs.core.truth_(remove_source_QMARK_)?cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__63783,source_path):G__63783);
var G__63783__$2 = ((com.fulcrologic.fulcro.algorithms.data_targeting.prepend_target_QMARK_(target))?com.fulcrologic.fulcro.algorithms.data_targeting.integrate_ident_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__63783__$1,item_to_place,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prepend","prepend",342616040),target], 0)):G__63783__$1);
var G__63783__$3 = ((com.fulcrologic.fulcro.algorithms.data_targeting.append_target_QMARK_(target))?com.fulcrologic.fulcro.algorithms.data_targeting.integrate_ident_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__63783__$2,item_to_place,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"append","append",-291298229),target], 0)):G__63783__$2);
if(com.fulcrologic.fulcro.algorithms.data_targeting.replacement_target_QMARK_(target)){
return com.fulcrologic.fulcro.algorithms.data_targeting.integrate_ident_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__63783__$3,item_to_place,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"replace","replace",-786587770),target], 0));
} else {
return G__63783__$3;
}
} else {

...
var len__4730__auto___53381 = arguments.length;
var i__4731__auto___53383 = (0);
while(true){
if((i__4731__auto___53383 < len__4730__auto___53381)){
args__4736__auto__.push((arguments[i__4731__auto___53383]));

var G__53384 = (i__4731__auto___53383 + (1));
i__4731__auto___53383 = G__53384;
continue;
} else {
}
break;
...
/** @this {Function} */
shadow.util.go_BANG_.cljs$lang$applyTo = (function (seq53271){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq53271));
});
...
var len__4730__auto___53398 = arguments.length;
var i__4731__auto___53399 = (0);
while(true){
if((i__4731__auto___53399 < len__4730__auto___53398)){
args_arr__4751__auto__.push((arguments[i__4731__auto___53399]));

var G__53401 = (i__4731__auto___53399 + (1));
i__4731__auto___53399 = G__53401;
continue;
} else {
}
break;
...
/** @this {Function} */
shadow.util.log.cljs$lang$applyTo = (function (seq53291){
var G__53292 = cljs.core.first(seq53291);
var seq53291__$1 = cljs.core.next(seq53291);
var G__53293 = cljs.core.first(seq53291__$1);
var seq53291__$2 = cljs.core.next(seq53291__$1);
var G__53294 = cljs.core.first(seq53291__$2);
var seq53291__$3 = cljs.core.next(seq53291__$2);
var G__53295 = cljs.core.first(seq53291__$3);
var seq53291__$4 = cljs.core.next(seq53291__$3);
var G__53296 = cljs.core.first(seq53291__$4);
var seq53291__$5 = cljs.core.next(seq53291__$4);
var G__53297 = cljs.core.first(seq53291__$5);
var seq53291__$6 = cljs.core.next(seq53291__$5);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53292,G__53293,G__53294,G__53295,G__53296,G__53297,seq53291__$6);
});

shadow.util.log.cljs$lang$maxFixedArity = (6);

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__53345){
var vec__53347 = p__53345;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53347,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53347,(1),null);

...
var map__63704 = app__$1;
var map__63704__$1 = (((((!((map__63704 == null))))?(((((map__63704.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__63704.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__63704):map__63704);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63704__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
...
return com.fulcrologic.fulcro.algorithms.scheduling.defer(((function (map__63704,map__63704__$1,runtime_atom){
return (function (){
...
});})(map__63704,map__63704__$1,runtime_atom))
,tm);
}
});
...
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63713__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
if(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(runtime_atom),scheduled_key))){
return null;
} else {
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(runtime_atom,cljs.core.assoc,scheduled_key,true);

var f = ((function (map__63713,map__63713__$1,runtime_atom){
return (function (){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(runtime_atom,cljs.core.assoc,scheduled_key,false);

return (action.cljs$core$IFn$_invoke$arity$0 ? action.cljs$core$IFn$_invoke$arity$0() : action.call(null));
});})(map__63713,map__63713__$1,runtime_atom))
;
